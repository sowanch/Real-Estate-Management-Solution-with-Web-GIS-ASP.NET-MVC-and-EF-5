...
namespace RenewedApartmentThingy.Controllers
{
    public class AgentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AgentID,AgentName,AgentNumber")] Agent agent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AgentID,AgentName,AgentNumber")] Agent agent)
        {
            if (ModelState.IsValid)
            {
